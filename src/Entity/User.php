...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    private DateTime|null $bannedUntil = null;
    ...
    public function getUserProfile(): UserProfile|null
    {
        return $this->userProfile;
    }

    public function setUserProfile(UserProfile|null $userProfile): static
    {
    ...
    public function getBannedUntil(): DateTime|null
    {
        return $this->bannedUntil;
    }

    public function setBannedUntil(DateTime|null $bannedUntil): static
    {
